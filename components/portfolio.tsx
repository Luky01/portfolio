  ...
  return (
    <main className="page-grid relative min-h-screen">
      <div className="cosmic-scene" aria-hidden="true">
        ...
        <div className="cosmic-comet cosmic-comet-tertiary" />
      </div>
      ...
      <section className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-20 pt-12 sm:px-6 sm:pt-16 lg:grid-cols-[minmax(0,1fr)_21rem] lg:gap-20 lg:px-8 lg:pb-24 lg:pt-20">
        <div className="hero-orbit pointer-events-none hidden lg:block" />
        <div className="fade-up">
          ...
          <p className="mt-8 text-lg font-medium text-sky-300">
      ...
      <section
        id="projetos"
        className="content-section mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16"
      >
          ...
          <div className="marquee-track flex items-center gap-10 py-4 sm:gap-12">
            {[...techLogos, ...techLogos].map((logo, index) => (
              ...
              >
                ...
                />
                <span className="text-xs font-mono tracking-wide text-slate-400 sm:text-sm">
                  {logo.label}
                </span>
              </div>
            ))}
      ...
      <section
        id="contato"
        className="content-section mx-auto max-w-7xl px-4 py-12 pb-16 sm:px-6 lg:px-8 lg:py-16 lg:pb-20"
      >
        <SectionHeading title={t.contact.title} intro={t.contact.intro} />

        <div className="relative mt-9 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.025] p-6 sm:p-8">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
            <div>
              ...
              <a
                ...
                className="mt-3 inline-flex items-center gap-3 text-2xl font-semibold tracking-tight text-white transition hover:text-sky-200 sm:text-3xl"
              >
      ...
      <footer className="border-t border-white/10 px-4 py-7 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 text-xs font-medium text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          <p>
            Braga Lima System — {t.footer.role}
          </p>
